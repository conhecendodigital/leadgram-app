...
-- 7. Inserir webhook padrão do Mercado Pago
...
-- 8. Comentários
COMMENT ON TABLE webhooks IS 'Webhooks configurados para notificar sistemas externos';
COMMENT ON TABLE webhook_logs IS 'Histórico de chamadas de webhook (sucesso e falhas)';
COMMENT ON FUNCTION update_webhook_stats(UUID, BOOLEAN, TEXT) IS 'Atualiza estatísticas do webhook após chamada';
COMMENT ON FUNCTION cleanup_old_webhook_logs() IS 'Remove logs de webhook com mais de 90 dias';
